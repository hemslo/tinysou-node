...
(function() {
  ...
  tasks = {
    ...
    searchAnalytics: function() {
      return tinysou.analytics.search(engine.name, {
        "function": 'count'
      }, function(err, res) {
        return display("search analytics", err, res);
      });
    },
    autocompleteAnalytics: function() {
      return tinysou.analytics.autocomplete(engine.name, {
        "function": 'top'
      }, function(err, res) {
        return display("autocomplete analytics", err, res);
      });
    },
    searchClickAnalytics: function() {
      return tinysou.analytics.searchClick(engine.name, {
        "function": 'top'
      }, function(err, res) {
        return display("searchClick analytics", err, res);
      });
    },
    autocompleteClickAnalytics: function() {
      return tinysou.analytics.autocompleteClick(engine.name, {
        "function": 'count'
      }, function(err, res) {
        return display("autocompleteClick analytics", err, res);
      });
    }
  };
